...
{
    public partial class ForChildren : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter sda;
        ...
        void getForChildren()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETFORCHILDREN");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rChildren.DataSource = dt;
            rChildren.DataBind();

        }

        protected void rChildren_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
