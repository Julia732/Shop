...
{
    public partial class Canned : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter sda;
        ...
        void getCanned()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETCANNED");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rCanned.DataSource = dt;
            rCanned.DataBind();

        }

        protected void rCanned_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
