<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Noodle.aspx.cs" Inherits="WebShop.User.Noodle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">МАКАРОНЫ И КРУПЫ</span></h2>
        </div>
        </div>
    <div class="filters_menu">
                    <div class="row grid">
    <asp:Repeater ID="rNoodle" runat="server" OnItemCommand="rNoodle_ItemCommand">
                            <ItemTemplate>
