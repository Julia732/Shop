<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Sausage.aspx.cs" Inherits="WebShop.User.Sausage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">КОЛБАСЫ И СОСИСКИ</span></h2>
        </div>
        </div>
