...
namespace WebShop.User
{
    public partial class Vegetables : System.Web.UI.Page
    {
        ...
        void getVegetables()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETVEGETABELS");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rVegetable.DataSource = dt;
            rVegetable.DataBind();

        }

        protected void rVegetable_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
