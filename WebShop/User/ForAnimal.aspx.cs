...
{
    public partial class ForAnimal : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter sda;
        ...
        void getForAnimal()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETFORANIMAL");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rAnimal.DataSource = dt;
            rAnimal.DataBind();

        }

        protected void rAnimal_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
