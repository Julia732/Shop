...
{
    public partial class Chips : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter sda;
        ...
        void getChips()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETCHIPS");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rChips.DataSource = dt;
            rChips.DataBind();

        }

        protected void rChips_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
