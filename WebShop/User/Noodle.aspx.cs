...
{
    public partial class Noodle : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        SqlDataAdapter sda;
        ...
        void getNoodle()
        {
            ...
            cmd.Parameters.AddWithValue("@Action", "GETNOODLE");
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
            sda.Fill(dt);
            rNoodle.DataSource = dt;
            rNoodle.DataBind();

        }

        protected void rNoodle_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
