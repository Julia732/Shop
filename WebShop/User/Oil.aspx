<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Oil.aspx.cs" Inherits="WebShop.User.Oil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">МАСЛО, СОУСЫ И СПЕЦИИ</span></h2>
        </div>
        </div>
   <div class="filters_menu">
                    <div class="row grid">
    <asp:Repeater ID="rOil" runat="server" OnItemCommand="rOil_ItemCommand">
                            <ItemTemplate>
