<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Vegetabels.aspx.cs" Inherits="WebShop.User.Vegetables" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid">
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">ОВОЩИ И ЗЕЛЕНЬ</span></h2>
            <div class="mb-4">
   ...
   <div class="filters_menu">
                    <div class="row grid">
    <asp:Repeater ID="rVegetable" runat="server" OnItemCommand="rVegetable_ItemCommand">
                            <ItemTemplate>
